...
type SharedInformerFactory interface {
	...
	Kafkaconnect() kafkaconnect.Interface
}

func (f *sharedInformerFactory) Kafkaconnect() kafkaconnect.Interface {
	return kafkaconnect.New(f, f.namespace, f.tweakListOptions)
}
