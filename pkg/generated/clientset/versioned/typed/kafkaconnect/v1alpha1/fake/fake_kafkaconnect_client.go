...
import (
	v1alpha1 "github.com/AmadeusITGroup/Kubernetes-Kafka-Connect-Operator/pkg/generated/clientset/versioned/typed/kafkaconnect/v1alpha1"
...
func (c *FakeKafkaconnectV1alpha1) KafkaConnectAutoScalers(namespace string) v1alpha1.KafkaConnectAutoScalerInterface {
	return &FakeKafkaConnectAutoScalers{c, namespace}
}
