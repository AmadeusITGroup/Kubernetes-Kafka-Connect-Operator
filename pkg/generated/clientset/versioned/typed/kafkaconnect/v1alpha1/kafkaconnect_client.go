...
import (
	...
	"github.com/AmadeusITGroup/Kubernetes-Kafka-Connect-Operator/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type KafkaconnectV1alpha1Interface interface {
	RESTClient() rest.Interface
	KafkaConnectsGetter
	KafkaConnectAutoScalersGetter
}
...
func (c *KafkaconnectV1alpha1Client) KafkaConnectAutoScalers(namespace string) KafkaConnectAutoScalerInterface {
	return newKafkaConnectAutoScalers(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*KafkaconnectV1alpha1Client, error) {
	...
	return &KafkaconnectV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KafkaconnectV1alpha1Client for the given config and
...
func New(c rest.Interface) *KafkaconnectV1alpha1Client {
	return &KafkaconnectV1alpha1Client{c}
}
